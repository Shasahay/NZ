    ...
    public static class DbContextExtensions
    {
            ...
            where T : class
        {
            ...
            var references = from navigationProperty in navigationProperties
                             ...
                             where end.RelationshipMultiplicity == System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne ||
                             end.RelationshipMultiplicity == System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.One
            ...
            foreach (var navigationProperty in references)
            {
                ...
                if (parentEntityState == System.Data.Entity.EntityState.Modified &&
                ...
                context.Entry(value).State = System.Data.Entity.EntityState.Unchanged;
            }
        }
